...
describe("extension card", () => {
  ...
  describe("an extension without a category", () => {
    const extension = {
      name: "JRuby",
      slug: "jruby-slug",
      metadata: {
        // categories is missing; some extensions have minimal metadata
      },
    }
  ...
  describe("an extension with a null category", () => {
    const extension = {
      name: "JRuby",
      slug: "jruby-slug",
      metadata: {
        // categories is missing; that might turn into a null, rather than an undefined
  ...
  describe("an extension with an empty category objects", () => {
    const extension = {
      name: "JRuby",
      slug: "jruby-slug",
      metadata: {
        // categories is missing; that might turn into an empty array, rather than an undefined
        categoryObjects: []
      },
    }
